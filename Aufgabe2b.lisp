...
(as name-alive-element
    (project (Name ElementName)
             (select (and (= Alive "TRUE") (= BenderID WesenID))
                     (x Wesen Bender))))

(format t "~% Lebendige Bender mit ihrem Element: ~a" (rows name-alive-element))
